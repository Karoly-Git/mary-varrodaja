...
export default function Info(props) {
    ...
    let allActiveVelemenyek = props.velemenyek.filter(
        (velemeny) => velemeny.isActive
    );
    ...
    return (
        <div className="info">
            ...
            {false && hirToBeDisplayed && (
                <div className="box hirek-box">
            ...
            <div className="box gyik-box">
                ...
                <div className="devider"></div>
                <ul>
                    {chooseRandomElement(2, allActiveGyik).map(
                        (element, gyikIndex) => (
                            <li key={gyikIndex}>
            ...
            <div className="box review-box">
                ...
                <div className="devider"></div>
                <ul>
                    {chooseRandomElement(2, allActiveVelemenyek).map(
                        (element, reviewIndex) => (
                            <li key={reviewIndex}>
                                <h4>{allActiveVelemenyek[element].name}</h4>
                                <p>
                                    " {allActiveVelemenyek[element].comment} "
                                </p>
                                {false && (
                                    <p className="date">
                                        {
